 ...
 *
 *  @param completionBlock A block that is called once the receiver is successfully updated.
 *  @param errorBlock      An error block that is called if the requested update fails to succeed.
